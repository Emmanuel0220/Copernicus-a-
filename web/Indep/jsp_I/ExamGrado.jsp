    ...
    <body>
        ...
        <div class="container">
            <section id="p0">
                ...
                <label>
                    <input type="radio" value="3" name="p0" onclick="respuesta(0, this)">Es la presentación de un lugar en el cielo
                </label>
            </section>
            ...
            <section id="p2">
                ...
                <label>
                    <input type="radio" value="1" name="p2" onclick="respuesta(2, this)">Mercurio, Marte, Júpiter, Tierra, Venus, Saturno, Urano, Neptuno

                </label>
                <label>
                    <input type="radio" value="2" name="p2" onclick="respuesta(2, this)">Mercurio, Venus, Tierra, Marte, Júpiter, Saturno, Urano, Neptuno

                </label>
                <label>
                    <input type="radio" value="3" name="p2" onclick="respuesta(2, this)">Mercurio, Urano, Júpiter, Saturno, Marte, Venus, Tierra, Neptuno
            ...
            <section id="p3">
                ...
                <label>
                    <input type="radio" value="1" name="p3" onclick="respuesta(3, this)">traslación
                </label>
                <label>
                    <input type="radio" value="2" name="p3" onclick="respuesta(3, this)">rotación
                </label>
                <label>
                    <input type="radio" value="3" name="p3" onclick="respuesta(3, this)">órbita
                </label>
            </section>
        ...
        %>
        <h2>Cantidad de aciertos: <%=corregir()%></h2>
